...
import '../logic/sales_notification_cubit.dart';
import '../logic/sales_notification_state.dart';

class SalesNotificationListView extends StatelessWidget {
  const SalesNotificationListView({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (BuildContext context) =>
            getIt<SalesNotificationCubit>()..getChefNotification(),
        child: Expanded(
          child: BlocBuilder<SalesNotificationCubit, ChefNotificationState>(
